...
public class SimBehaviourGoTo : SimBehaviourBase
{
    ...
    public override void Update()
    {
        ...
        sim.transform.forward = Vector3.RotateTowards(sim.transform.forward,
                    interactable.transform.position - sim.transform.position,
                    5 * Time.deltaTime,
                    10f * Time.deltaTime);
        sim.transform.position = Vector3.MoveTowards(sim.transform.position, 
